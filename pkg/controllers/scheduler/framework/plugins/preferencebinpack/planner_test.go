...
func Test_getDesiredPlan(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, got1 := getDesiredPlan(tt.args.preferences, tt.args.estimatedCapacity, tt.args.limitedCapacity, tt.args.totalReplicas, tt.args.keepUnschedulableReplicas)
...
func TestWithExistingAndCapacity(t *testing.T) {
	doCheckWithExistingAndCapacity(t,
		...
		[4]*expectedResult{
			{
				plan:     map[string]int64{"A": 50, "B": 0},
				overflow: map[string]int64{},
			},
			{
				plan:     map[string]int64{"A": 50, "B": 0},
			...
			{
				plan:     map[string]int64{"A": 40, "B": 10},
				overflow: map[string]int64{},
			},
			{
				plan:     map[string]int64{"A": 40, "B": 10},
	...
	doCheckWithExistingAndCapacity(t,
		&testCase{
			...
			replicas: 50,
			clusters: []string{"A", "B", "C"},
			existing: map[string]int64{"A": 50},
			capacity: map[string]int64{"A": 10},
		},
		[4]*expectedResult{
			{
				plan:     map[string]int64{"A": 10, "B": 40, "C": 0},
				overflow: map[string]int64{"A": 40},
			},
			{
				plan:     map[string]int64{"A": 10, "B": 40, "C": 0},
				overflow: map[string]int64{"A": 40},
	...
	doCheckWithExistingAndCapacity(t,
		&testCase{
			...
			replicas: 50,
			clusters: []string{"A", "B", "C"},
			existing: map[string]int64{"A": 50, "B": 40},
			capacity: map[string]int64{"A": 10, "B": 10},
		},
		[4]*expectedResult{
			{
				plan:     map[string]int64{"A": 10, "B": 10, "C": 30},
	...
	doCheckWithExistingAndCapacity(t,
		&testCase{
			...
			replicas: 50,
			clusters: []string{"A", "B", "C"},
			existing: map[string]int64{"A": 50, "B": 40, "C": 30},
			capacity: map[string]int64{"A": 10, "B": 10, "C": 10},
		},
		[4]*expectedResult{
			{
				plan:     map[string]int64{"A": 10, "B": 10, "C": 10},
				overflow: map[string]int64{"A": 40, "B": 30, "C": 20},
			},
			{
				plan:     map[string]int64{"A": 10, "B": 10, "C": 10},
				overflow: map[string]int64{"A": 40, "B": 30, "C": 20},
			...
			{
				plan:     map[string]int64{"A": 10, "B": 10, "C": 10},
				overflow: map[string]int64{"A": 20, "B": 20, "C": 20},
			},
			{
				plan:     map[string]int64{"A": 10, "B": 10, "C": 10},
				overflow: map[string]int64{"A": 40, "B": 30, "C": 20},
	...
	doCheckWithExistingAndCapacity(t,
		&testCase{
			...
			clusters: []string{"A", "B", "C"},
			existing: map[string]int64{"A": 50, "B": 40, "C": 30},
			capacity: map[string]int64{"A": 40, "B": 10},
		},
		[4]*expectedResult{
			{
				plan:     map[string]int64{"A": 40, "B": 10, "C": 0},
				overflow: map[string]int64{"A": 10},
			},
			{
				plan:     map[string]int64{"A": 40, "B": 10, "C": 0},
				overflow: map[string]int64{"A": 10},
	...
	doCheckWithExistingAndCapacity(t,
		&testCase{
			...
			replicas: 50,
			clusters: []string{"A", "B", "C"},
			existing: map[string]int64{"A": 50, "B": 0, "C": 0},
			capacity: map[string]int64{"A": 20},
		},
		[4]*expectedResult{
			{
				plan:     map[string]int64{"A": 20, "B": 30, "C": 0},
	...
	doCheckWithExistingAndCapacity(t,
		&testCase{
			...
			replicas: 50,
			clusters: []string{"A", "B", "C"},
			existing: map[string]int64{"A": 20, "B": 30, "C": 0},
			capacity: map[string]int64{"B": 20},
		},
		[4]*expectedResult{
			{
	...
	doCheckWithExistingAndCapacity(t,
		&testCase{
			...
			clusters: []string{"A", "B", "C"},
			existing: map[string]int64{"A": 50, "B": 40, "C": 30},
			capacity: map[string]int64{"A": 20, "B": 10},
		},
		[4]*expectedResult{
			{
