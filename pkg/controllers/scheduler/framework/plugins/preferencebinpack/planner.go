...
func scaleUp(
	...
	replicasToScaleUp, _ := getDesiredPlan(namedPreferences, nil, nil, scaleUpCount, false)
...
func scaleDown(
	...
	// no estimatedCapacity and hence no overflow
	replicasToScaleDown, _ := getDesiredPlan(namedPreferences, nil, nil, scaleDownCount, false)
